...
export const NeoCard = ({ 
  ...
  const baseClasses = `bg-white border-[3px] border-black ${rounded} ${padding} transition-all duration-200 relative overflow-hidden`;
  ...
  return (
    <div 
      ...
      style={{ '--shadow-color': shadowColor, ...props.style }}
      {...props}
    >
      {children}
    </div>
